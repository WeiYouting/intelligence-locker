...
public class OrderUtil {
     ...
     */
        ...
        private static final String ORDER_CODE = "IL";
        /**
         * 退货类别头
         */
        ...
        private static String toCode(String userId) {
            ...
            for (int i = userId.length() - 1; i >= 0; i--) {
                idsbs.append(r[userId.charAt(i) - '0']);
            }
            return idsbs.append(getRandom(maxLength - userId.length())).toString();
        }
